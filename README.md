...
Running the Model
To execute the training and evaluation pipeline, run the following command:

Bash

python car_brand_classification_model.py
Credits & Acknowledgments
This project was originally developed as part of a collaborative initiative at the Michigan Data Science Team (MDST).

Special thanks to the researchers behind the Stanford Car Dataset for providing high-quality labeled data.
